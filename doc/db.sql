...
CREATE TABLE `tb_apk_version`  (
  ...
  `create_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
...
CREATE TABLE `tb_app_update`  (
  ...
  `upload_time` datetime  DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '上传时间'
